...
function inferSocketSize(name) {
  const exact = {
    ...
    "Socket 4677": { w: 72.5, h: 57.5 },
    "Socket 1567": { w: 49.1, h: 56.4 },
    ...
    "Socket FM2+": { w: 40, h: 40 },
    "Socket TR4": { w: 58.5, h: 51 },
    "Socket sTRX4": { w: 58.5, h: 51 },
    "Socket sTR5": { w: 58.5, h: 75.4 },
    "Socket SP3": { w: 58.5, h: 75.4 },
    "Socket SP5": { w: 72, h: 75.4 },
    "Slot 1": { w: 110, h: 18 },
    "Slot 2": { w: 110, h: 18 },
    "Slot A": { w: 110, h: 18 }
  };
  ...
  if (name.startsWith("Socket G") || ["Socket M", "Socket P", "Socket T", "Socket H", "Socket R", "Socket B"].includes(name)) {
    return { w: 35, h: 35 };
  }

  // For legacy sockets with inconsistent or poorly documented package dimensions,
  // keep a conservative square package footprint.
